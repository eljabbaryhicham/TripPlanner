    ...
    xhr.onload = () => {
      ...
      if (xhr.status >= 200 && xhr.status < 300) {
        try {
            ...
            toast({ variant: 'destructive', title: 'Upload Response Error', description: 'Could not process server response after upload. Refreshing...' });
            fetchMedia();
        }
      } else {
        try {
            ...
            <DialogContent className="max-w-4xl h-[80vh] flex flex-col">
                <DialogHeader>
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <Button onClick={() => fileInputRef.current?.click()} disabled={uploadProgress !== null || !isConfigured}>
